...
using MDCSoftware.API.Models;

namespace MDCSoftware.API.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class PessoasController : ControllerBase
    {
        private readonly MDCSoftwareAPIContext _context;

        public PessoasController(MDCSoftwareAPIContext context)
        {
            _context = context;
        }
